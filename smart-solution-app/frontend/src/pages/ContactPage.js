...
const ContactPage = () => {
  ...
  if (done) return (
    <div style={{ minHeight: "80vh", display: "flex", alignItems: "center", justifyContent: "center", background: C.offWhite, padding: "40px 24px" }}>
      <div style={{ background: "white", borderRadius: 24, padding: "64px 48px", textAlign: "center", maxWidth: 500, boxShadow: "0 8px 48px rgba(0,0,0,0.08)" }}>
    ...
    <div>
      <section style={{ background: `linear-gradient(135deg,${C.navy},${C.navyLight})`, padding: "100px 24px 72px", position: "relative" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", textAlign: "center" }}>
          ...
          <h1 style={{ fontFamily: C.FD, fontSize: 72, color: "white", marginBottom: 18 }}>GET IN TOUCH</h1>
          <p style={{ color: "rgba(255,255,255,0.6)", fontSize: 18, maxWidth: 600, margin: "0 auto" }}>Request a free quote or ask us anything about your electrical project.</p>
        </div>
      ...
      <section style={{ padding: "80px 24px", background: C.offWhite }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1.5fr", gap: 52 }}>
          {/* Info */}
          <div>
            ...
            <div style={{ background: C.navy, borderRadius: 16, padding: "26px" }}>
